...
/**
 * Base hardware acceleration configuration.
 *
 * This file provides the base hwaccel settings without any merging.
 * It is used by HwAccelConfig::get() to build the authoritative merged config.
 *

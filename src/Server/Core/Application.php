    ...
    private function loadApiRoutes(): void
    {
        ...
        $this->router->group(
            ...
            function (Router $r) use ($markerController, $extrasController, $subtitleController): void {
                ...
                // Marker thumbnail serving — the URL is generated by Marker::toArray()
                // as /api/v1/markers/thumbnails/{urlencoded_path}. The path stored in
                // media_markers.thumbnail_path is an absolute filesystem path.
                $r->get('/api/v1/markers/thumbnails/{path}', [$markerController, 'getMarkerThumbnail']);

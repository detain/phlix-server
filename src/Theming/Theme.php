 ...
 * (shipped with Phlix) or provided by ui-theme plugins.
 *
...
class Theme
{
     ...
     *
     * @param string $id Unique theme identifier (e.g., 'phlix-dark')
     * @param string $name Human-readable theme name (e.g., 'Phlix Dark')

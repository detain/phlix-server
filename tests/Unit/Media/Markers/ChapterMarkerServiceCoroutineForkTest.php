 ...
 * PINNED as S403 — see the contract test
 * `CoroutineShellExecDivergenceContractTest` — rather than patched, because
 * no code-based rule can make the arms identical for every input without

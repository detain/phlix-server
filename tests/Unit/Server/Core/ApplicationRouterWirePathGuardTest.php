...
final class ApplicationRouterWirePathGuardTest extends TestCase
{
    ...
    private const ROUTE_MANIFEST = [
        ...
        'GET /api/v1/admin/telemetry/clients -> QuickConnectController::adminClients [AdminMiddleware]',
        ...
        'GET /api/v1/auth/quick-connect/{code}/status -> QuickConnectController::status []',
        ...
        'GET /api/v1/music/album -> MusicController::getAlbumByTitleQuery [AuthMiddleware]',
        ...
        'GET /api/v1/music/artist -> MusicController::getArtistByNameQuery [AuthMiddleware]',
        ...
        'POST /api/v1/auth/quick-connect/initiate -> QuickConnectController::initiate []',
        'POST /api/v1/auth/quick-connect/{code}/approve -> QuickConnectController::approve [AuthMiddleware]',
        'POST /api/v1/auth/quick-connect/{code}/token -> QuickConnectController::token []',
        ...
        'POST /api/v1/telemetry/heartbeat -> QuickConnectController::heartbeat []',

...
final class HubJwksControllerRateLimitTest extends TestCase
{
     ...
     */
    private function makeLimiter(bool $limited): HubJwksRecordingRateLimiter
    {
        return new HubJwksRecordingRateLimiter($limited);
    }
 ...
 * {@see HubJwksControllerRateLimitTest::makeLimiter()}).
 */
final class HubJwksRecordingRateLimiter implements RateLimiterInterface
{
    /** @var list<string> */
    public array $hits = [];
